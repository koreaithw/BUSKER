...
// Genrelist
function jsf_genre_GetGenreList(genre, genretype, sort) { //아티스트 타입 //

    prevArtistSort = artistSort;
    artistSort = sort;
...
function jsf_genre_SetSortOrderClass() {
    ...
    $('.li-sec-tag').find("a[token='" + (artistSort) + "']").addClass("on")
}
